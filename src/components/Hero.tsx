...
const Hero = () => {
  return <section className="img">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent bg-[#13bb00]">
        <div className="container-custom h-full flex items-center">
          <div className="max-w-2xl pt-20">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-lg animate-fade-in" style={{
