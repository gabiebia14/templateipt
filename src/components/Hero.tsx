  ...
  return (
    <section className="relative h-screen bg-machinery-black">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "url('https://images.unsplash.com/photo-1483569577148-f14683bed627?q=80&w=2070&auto=format&fit=crop')",
        ...
        <div className="container-custom h-full flex items-center">
          <div className="max-w-2xl pt-20">
            <h1 className="text-white mb-6 animate-fade-in">
              <span className="text-machinery-yellow">Industrial</span> Strength <br />
              For Every Challenge
            </h1>
            <p className="text-gray-300 text-lg mb-8 max-w-lg animate-fade-in" style={{ animationDelay: "200ms" }}>
              We provide high-quality heavy equipment and machinery for construction, 
              mining, and industrial applications worldwide.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in" style={{ animationDelay: "400ms" }}>
              <button className="btn-primary flex items-center gap-2 rounded">
                Our Equipment <ArrowRight className="h-5 w-5" />
              </button>
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-machinery-black bg-opacity-90 py-6">
        <div className="container-custom grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          ...
          <div className="animate-fade-in" style={{ animationDelay: "700ms" }}>
            <h3 className="text-machinery-yellow text-4xl font-bold">500+</h3>
            <p className="text-white">Projects Completed</p>
          </div>
          <div className="animate-fade-in" style={{ animationDelay: "800ms" }}>
            <h3 className="text-machinery-yellow text-4xl font-bold">100+</h3>
            <p className="text-white">Equipment Units</p>
          </div>
